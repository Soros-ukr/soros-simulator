...
gameScene.createUi = function() {
  // buttons
  this.appleBtn = this.add.sprite(65, 570, 'apple').setInteractive();
  this.appleBtn.setScale(0.4);
  ...
  this.candyBtn = this.add.sprite(155, 570, 'candy').setInteractive();
  this.candyBtn.setScale(0.4);
  ...
  this.toyBtn = this.add.sprite(245, 570, 'toy').setInteractive();
  ...
  this.rotateBtn = this.add.sprite(315, 570, 'rotate').setInteractive();
  this.rotateBtn.customStats = {
    fun: 20
  };
  this.rotateBtn.setScale(0.3);
...
gameScene.placeItem = function(pointer, localX, localY) {
  ...
  newItem.setScale(this.selectedItem.scaleX);
  // block UI
  this.uiBlocked = true;
...
gameScene.updateStats = function(statDiff) {
  ...
  if(isGameOver) {
      ...
      this.stats.score += (0.7 * this.stats.health + 0.4 * this.stats.fun) / 2.0;
  }
};
